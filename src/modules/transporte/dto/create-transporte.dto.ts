...
export class CreateTransporteDto {
    ...
    @MaxLength(150,{message:'The file number must be less than 50 characters'})
    ...
    @MaxLength(120,{message:'The engine number must be less than 20 characters'})
    ...
    @MaxLength(130,{message:'The chassis number must be less than 30 characters'})
    ...
    @MaxLength(150, { message: 'The car brand must be less than 50 characters' })
    ...
    @ApiProperty({
      example: 'Aridos',
      description: 'Type of transports',
      maxLength: 10,
      minLength: 4,
    })
    @IsEnum(['Carga-Descarga', 'Aridos'], 
        { message: 'The type of transports must be one of: Carga-Descarga or Aridos' })
